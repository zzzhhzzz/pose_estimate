...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='my_datas/mydata_1.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'my_datas/mydata.yaml', help='dataset.yaml path')
